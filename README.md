...
## My Contribution
I extended this open-source speech emotion recognition system with:

- Real-time emoji visualization for detected emotions
- Improved testing workflow for live microphone input
- Minor preprocessing and output formatting improvements

This enhancement makes the system easier to interpret during live phone-call sentiment monitoring.

## Introduction
- This repository builds and trains a Speech Emotion Recognition system.
- The goal of this system is to train machine learning and deep learning models to recognize human emotions from speech signals.
...
This project is based on an open-source speech emotion recognition system and extended with emoji-based visualization output and testing improvements.
